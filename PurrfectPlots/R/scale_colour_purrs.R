...
#'
#' This function loads the respective palette and applies the color to the ggplot.
#'
#' @param n name of the color palette. Defaults to lily. Available options are: "lily", "binky", "teddy", "ginger", "grumpyCat", "caliente", "disney"
#' @return The color palette of choice (catlette)
#' @export
purrs.colors <- function(n="lily") {
  if (n=="lily"){
...
#' Get the cat coloured palette
#'
#' This function loads the respective palette and applies the colour to the ggplot.
#'
#' @param n name of the colour palette. Defaults to lily. Available options are: "lily", "binky", "teddy", "ginger", "grumpyCat", "caliente", "disney"
#' @return The colour palette of choice (catlette)
#' @export
...
scale_color_purrs <- function(palette_name="lily", ...) {
  ggplot2::scale_color_manual(values = purrs.colors(palette_name), ...)
}
...
scale_fill_purrs <- function(palette_name="lily", ...) {
  ggplot2::scale_fill_manual(values = purrs.colors(palette_name), ...)
}
